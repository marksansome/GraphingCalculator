...
def UI():
	...
	goButton = Button(entryFrame, text = "Go", bg = "#333333", fg ="#ffffff", font = boldFont, command = lambda: generateGraph(root, entry.get(), minRange.get(), maxRange.get(), interval.get()))
